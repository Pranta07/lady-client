    ...
    return (
        <div className='pt-16 bg-black text-white'>
            <div className='grid lg:grid-cols-4 text-white sm:grid-cols-1 md:grid-cols-2 sm:grid-cols-1 justify-items-center gap-4'>
                <div>
                    <h2 className='hover:underline-offset-8 title font-bold hover:text-slate-400'>QUICK-LINKS</h2>
                    <div className='flex flex-col mt-8 link text-justify font-normal'>
                        ...
                        <a className='box' href="#shippingInfo">  SHIPPING INFO</a>
                    </div>
                </div>
                <div className='text-justify'>
                    <h2 className='hover:underline-offset-8 title font-bold hover:text-slate-400'>RECENT BLOGS</h2>

                    <div className='mt-8 flex flex-col blogs-item'>
                        <div>
                            <p>
                                TOP 10 TRENDING DRESS THIS SUM
                            </p>
                        </div>
                        <div>
                            <p>
                                THE AWESOME CUTE STACK
                            </p>
                        </div>
                        <div>
                            <p>
                                NEWS ABOUT OPEN HOUR OF STORE
                            </p>
                        </div>
                    </div>
                </div>
                <div className='text-justify'>
                    <h2 className='hover:underline-offset-8 title font-bold hover:text-slate-400'>TAGS</h2>
                ...
                <div className='text-justify'>
                    ...
                    <div className=' mx-2 mt-6'>
                        ...
                        <p className='text-sm hover:text-slate-400'> Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            ...
            <p className='p-4 font-normal text-slate-100 hover:text-slate-400'>COPYRIGHT 2022 BY Hero-Team-Mate . ALL RIGHTS RESERVED</p>
        </div>
    );
};
